...
class ShowtimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create showtime" do
    assert_difference("Showtime.count") do
      post showtimes_url, params: { showtime: { available_seats: @showtime.available_seats, movie_id: @showtime.movie_id, show_date: @showtime.show_date, theater_id: @showtime.theater_id } }
    end
  ...
  test "should update showtime" do
    patch showtime_url(@showtime), params: { showtime: { available_seats: @showtime.available_seats, movie_id: @showtime.movie_id, show_date: @showtime.show_date, theater_id: @showtime.theater_id } }
